...
import Nav from '../Nav/Nav'; // Importa el componente Nav
...
function Hombres() {
    ...
    const HombresSeleccionada = HombresData.Hombres;
    const { title, zapatillas, className } = HombresSeleccionada;
            ...
            <div className="hombres-container">
                ...
                <div className={className ? `lista-zapatillas-${className}` : 'lista-zapatillas'}>
                    {zapatillas.map((item, index) => (
                        <div
                            key={index}
                            className={className ? `caja-zapatillas-${className}` : 'caja-zapatillas'}
                        >
